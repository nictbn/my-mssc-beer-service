package guru.springframework.mymsscbeerservice.web.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import guru.springframework.mymsscbeerservice.bootstrap.BeerLoader;
import guru.springframework.mymsscbeerservice.services.BeerService;
...
class BeerControllerTest {
    ...
    void getBeerById() throws Exception {
        given(beerService.getById(any(), eq(false))).willReturn(getValidBeerDto());
